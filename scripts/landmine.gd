...
func _on_area_3d_body_entered(body: Node3D) -> void:
	if body == GLOBAL.player:
		...
		GLOBAL.playsound3d(preload("res://assets/audio/sfx/hazards/landmine_explode.wav"), global_position, 20.0)
		...
		for i in range(1000):
			...
			DebugDraw3D.draw_line(global_position, to, Color.YELLOW, 0.1)
